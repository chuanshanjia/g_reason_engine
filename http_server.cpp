...
DEFINE_string(certificate, "/home/work/data/glaucus_reason_engine/cert.pem", "Certificate file path to enable SSL");
DEFINE_string(private_key, "/home/work/data/glaucus_reason_engine/key.pem", "Private key file path to enable SSL");
